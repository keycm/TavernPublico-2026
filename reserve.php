...
<head>
    ...
    <style>
        ...
        .reservation-form .form-group textarea { /* Added textarea */
            width: 100%;
        ...
        .reservation-form .form-group textarea:focus { /* Added textarea */
        ...
        body.dark-theme .reservation-form .form-group textarea { /* Added textarea */
...
<body>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            // --- COUPON JAVASCRIPT REMOVED ---
            // The entire applyCouponBtn logic has been removed.
