document.addEventListener('DOMContentLoaded', () => {
    ...
    const modalSpecialRequests = document.getElementById('modalSpecialRequests'); // <-- ADDED
    ...
    function openReservationModal(reservationData) {
        // MODIFIED: Added modalSpecialRequests to the check
        if (!reservationModal || !modalReservationId || !modalResName || !modalResEmail || !modalResPhone || !modalResDate || !modalResTime || !modalNumGuests || !modalReservationType || !modalStatus || !modalCreatedAt || !validIdDisplay || !modalActionBy || !modalSpecialRequests) {
        ...
        modalSpecialRequests.value = reservationData.special_requests || ''; // <-- ADDED
