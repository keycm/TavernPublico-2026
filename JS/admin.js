document.addEventListener('DOMContentLoaded', () => {
    ...
    if (modalConfirmBtn) modalConfirmBtn.addEventListener('click', () => handleAction(modalConfirmBtn, 'Confirmed', 'update', '/update_reservation_status')); // <-- FIXED
    if (modalDeclineBtn) modalDeclineBtn.addEventListener('click', () => handleAction(modalDeclineBtn, 'Declined', 'update', '/update_reservation_status')); // <-- FIXED
    ...
    if (confirmDeleteBtn) {
         confirmDeleteBtn.addEventListener('click', () => {
            if(currentReservationId) {
                handleAction(confirmDeleteBtn, null, 'delete', '/update_reservation'); // <-- FIXED
            }
         });
    }
